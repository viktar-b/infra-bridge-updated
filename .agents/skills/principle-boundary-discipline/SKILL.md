...
> **Codex host mapping:** Before following an instruction that names Cursor, `Task`, a
> subagent type, a slash command, a Cursor-only model, or a Cursor configuration path, read
> [the Codex host mapping](../poteto-mode/references/codex-host.md) and apply it.
